...
python /users/wl42/OmniCal/mp2cal/scripts/cal_apply_average.py --fhdpath='/users/wl42/data/wl42/FHD_out/fhd_Calibration_PhaseII/' --outpath='./' --subtract --omnipath='./calibration/red/' $obs
